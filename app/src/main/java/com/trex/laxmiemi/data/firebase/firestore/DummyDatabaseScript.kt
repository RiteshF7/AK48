...
class DummyDatabaseScript {
    ...
    fun createShop(shopId: String, ownerName: String, shopName: String, tokenBalance: Int) {
        ...
        db.collection("shops").document(shopId).set(shopData)
    ...
    fun addDeviceToShop(shopId: String, imei: String, customerName: String, emiStatus: String, lastPaymentDate: String, dateTimeSold: String, tokenId: String, emiDueDate: String, lockStatus: String) {
    ...
    fun setupFirestoreData() {
        ...
        addDeviceToShop(
            shopId, "123456789012345", "Jane Smith", "on-time",
            "2024-09-01", "2024-09-10T12:00:00Z", "token123", "2024-10-10", "unlocked"
        )
    }
    ...
    fun testFirestoreOperations() {
        ...
        // Create a new shop
        shopFirestore.createOrUpdateShop(null, Shop(ownerName = "John Doe", shopName = "Doe's Electronics", tokenBalance = 100), {
        ...
        deviceFirestore.createOrUpdateDevice(null, NewDevice(imeiOne = "123456789", costumerName = "Jane Doe", fcmToken = "", shopId = ""), {
