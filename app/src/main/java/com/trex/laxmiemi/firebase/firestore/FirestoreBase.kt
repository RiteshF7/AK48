...
abstract class FirestoreBase<T : Any>(private val collectionPath: String) {
    ...
    open fun getDocument(docId: String, clazz: Class<T>, onSuccess: (T) -> Unit, onFailure: (Exception) -> Unit) {
    ...
    open fun addOrUpdateDocument(docId: String? = null, data: T, onSuccess: () -> Unit, onFailure: (Exception) -> Unit) {
        val docRef = if (docId == null) db.collection(collectionPath).document() else db.collection(collectionPath).document(docId)
        docRef.set(data, SetOptions.merge()) // Merge updates or add new document
    ...
    open fun updateSingleField(docId: String, fieldName: String, fieldValue: Any, onSuccess: () -> Unit, onFailure: (Exception) -> Unit) {
    ...
    open fun getSingleField(docId: String, fieldName: String, onSuccess: (Any) -> Unit, onFailure: (Exception) -> Unit) {
    ...
    open fun deleteDocument(docId: String, onSuccess: () -> Unit, onFailure: (Exception) -> Unit) {
