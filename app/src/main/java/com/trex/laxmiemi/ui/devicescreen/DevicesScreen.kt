...
import com.trex.laxmiemi.ui.createdevicescreen.SearchBox
...
private fun DeviceList(
    ...
    Column(
        ...
        SearchBox(
            ...
            onSearch = { query -> viewModel.searchDevice(query) },
        )
        Spacer(modifier = Modifier.height(8.dp)) // Add a spacer for some padding between the search box and the list
        LazyColumn(
            modifier = Modifier.fillMaxSize(),
        ) {
